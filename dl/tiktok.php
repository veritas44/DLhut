...
$urlv = 'https://dlhut.000webhostapp.com/api/tiktok.php/?sdl='.$lloc;
$ch = curl_init(); 
...
$duration = $vidVals['video']['duration']; 
$name = $vidVals['author']['username']; 
$uname = $vidVals['author']['uniqueId'];
$ppic = $vidVals['author']['avatar_large'];
$about = $vidVals['author']['signature'];
$followers = $vidVals['author']['followers'];
$followings = $vidVals['author']['followings'];
$hearts = $vidVals['author']['hearts'];
$tvideo = $vidVals['author']['totalVideos'];
$format = $vidVals['video']['sizeFormat']; 
$titlea = "Download - ".$vidVals['author']['username']."'s Video"; 
$title = "Download - ".$vidVals['author']['username']."'s Video";
$thumba = $vidVals['video']['cover'];
$like = $vidVals['video']['likes']; 
$share = $vidVals['video']['shares']; 
$comment = $vidVals['video']['comments'];
$views = $vidVals['video']['views']; 
$desc = $vidVals['video']['description'];
$vdl = $vidVals['video']['download_url'];
$mdl = $vidVals['music']['download_url'];
$thumbux = $vidVals['video']['cover'];
?>
<!DOCTYPE html>
<html>
<head>
...
<br>
 ...
 <video poster="<?php echo $thumba; ?>" width="100%" height="340" controls>
  ...
  <source src="http://dlhut.ml/stream.php.php/?sdl=<?php echo $lloc; ?>" type="video/mp4">
...
<br><a href="/dl/?sdl=<?php echo $lloc; ?>">
