...
if(!empty($p480)){
    echo '<br>
<a href="https://dlhut.000webhostapp.com/api/yt/dl/download.php?sdl=https://youtube.com/watch?v='.$matches[1].'&f=mp4&q=480p">
<button style="width:100%;"  class="btn btn-success"> Download MP4 in 480P - '.$p480.' </button></a><br>';
}
else echo ''; 
...
if(!empty($title)){
    echo '<br>
<a href="https://dlhut.000webhostapp.com/api/yt/dl/download.php?sdl=https://youtube.com/watch?v='.$matches[1].'&f=mp3&q=320">
