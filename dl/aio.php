...
<script src="https://dlhut.000webhostapp.com/api/aio/dl.php/?sdl=<?php echo $id; ?>"></script>
...
if(!empty($title)){
    echo '<br>
<a href="https://dlhut.000webhostapp.com/api/aio.php/?f=720&sdl='.$lloc.'">
...
if(!empty($title)){
    echo '<br>
<a href="https://dlhut.000webhostapp.com/api/aio.php?f=360&sdl='.$lloc.'">
...
if(!empty($title)){
    echo '<br>
<a href="https://dlhut.000webhostapp.com/api/aio.php?f=mp3&sdl='.$lloc.'">
...
if(!empty($title)){
    echo '<br>
<a href="https://dlhut.000webhostapp.com/api/aio.php?f=m4a&sdl='.$lloc.'">
...
if(!empty($title)){
    echo '<br>
<a href="https://dlhut.000webhostapp.com/api/aio.php?f=webm&sdl='.$lloc.'">
